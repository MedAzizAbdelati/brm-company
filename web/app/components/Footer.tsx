...
export function Footer() {
  ...
  const socialLinks = [
    { icon: <FaFacebook />, href: 'https://www.facebook.com/profile.php?id=61572900340594' },
    { icon: <FaLinkedin />, href: 'https://www.linkedin.com/company/brmmansour/' },
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-1">
            ...
            <p className="text-gray-400 mb-4">
              Spécialistes en import/export de produits naturels de qualité supérieure depuis 2023.
            </p>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} BRM Company. Tous droits réservés.
          </p>
        </div>
      </div>
    </footer>
